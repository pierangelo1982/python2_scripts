...
url = "https://www.dati.lombardia.it/resource/e47p-yvau.json"
...
for dato in data:
    if dato['denominazione_struttura'] != "VO'" and dato['classificazione'] == "Alberghi 4 stelle":
...
# save pdf
pdf.output('Alberghi_4_stelle.pdf', 'F')